...
class EggCodeInterpreter:
    ...
    def create_batch(self, commands):
        self.batch_commands.extend(commands.split(';'))

    def render(self):
        for sprite_name, sprite in self.sprites.items():
            print(f"Sprite {sprite_name} at ({sprite.x}, {sprite.y})")
        self.display_clock()
        print("Refreshes screen and displays clock.")
    ...
    def display_help(self):
        ...
        print("batch <commands>: Create a batch of commands")
        print("run: Execute the batch of commands")
        print("exit: Exit EggShell")

    def display_tips_and_tricks(self):
        print("EggCode Tips and Tricks:")
        print("- Test your code frequently to catch and fix errors early in batch files.")
        print("Use the help command if you forget a command!")
